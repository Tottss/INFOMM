    ...
    <body>
        ...
        <form action="labreport_process.jsp" method="post">
            ...
            <select name="payment_id" id="payment_id">
                <jsp:include page="helper_select_payments.jsp"></jsp:include>
            </select><br>
            ...
            <label for="lab_results">Findings</label>
            ...
            <select id="report_status" name="report_status" required>
                ...
                <option value="Pending">M</option>
                <option value="Completed">F</option>
            </select>
            <br>
            ...
            <select id="payment_status" name="payment_status" required>
                <option value="">Select</option>
                <option value="Unpaid">M</option>
                <option value="Paid">F</option>
            </select>
            <br>
